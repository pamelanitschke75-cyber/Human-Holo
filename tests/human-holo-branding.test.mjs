...
test("aktueller Bildschirm nutzt Human Holo und bewahrt Pam’s Holo", () => {
  ...
  assert.match(html, /sol-holo-ui\.js\?v=79/u);
  ...
  assert.doesNotMatch(ui, /aboutHumanHolo|Über Human Holo|humanHoloAboutCredit/u);
  assert.doesNotMatch(css, /humanHoloAboutCredit/u);
  assert.match(css, /Sichtbare gemeinsame Human-Holo-Zuordnung · Startseite/u);
