...
public final class WakeRecognitionLifecyclePolicyTest {
    ...
    private static void rearmsOnlyAnIdleBackgroundListener() {
        assertTrue(rearm(true, false, false, false, false));
        assertFalse(rearm(false, false, false, false, false));
        assertFalse(rearm(true, true, false, false, false));
        assertFalse(rearm(true, false, true, false, false));
        assertFalse(rearm(true, false, false, true, false));
        assertFalse(rearm(true, false, false, false, true));
    }
