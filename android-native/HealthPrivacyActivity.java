...
public class HealthPrivacyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        policy.setText(
            ...
            "des Android-Datensatzes in das Gedächtnis. Die ausdrücklich gestellte " +
            "Frage und die daraus erzeugte angezeigte Antwort bleiben wie andere " +
            "Gespräche ownergebunden in Pams Vollzeitgedächtnis.\n\n" +
